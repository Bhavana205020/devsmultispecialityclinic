  ...
  return (
    <div className="sticky top-0 z-50 w-full bg-soft/60 backdrop-blur-md py-3">
      <header className="mx-auto max-w-7xl px-4">
        <div className="bg-background rounded-full shadow-soft border border-border/60 flex items-center justify-between pl-4 pr-2 h-24 md:h-28">
          <button onClick={() => scrollTo("home")} className="flex items-center gap-2 shrink-0">
            <img src={logo} alt="Dev's Multispeciality Clinic" className="h-16 md:h-20 w-auto" />
          </button>
